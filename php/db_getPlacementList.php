...
//    $dbConn->query($query4);
    ...
    $query = "SELECT wspl.WSampleID AS WSampleID, "
            ...
            . "WHEN scre.R3Score IS NULL AND scre.R1Score = 3 AND (scre.R1ESL = 0 OR scre.R2ESL = 1) THEN 'ESL 201' "
            ...
            . "WHEN scre.R3Score IS NULL AND scre.R1Score = 2 AND (scre.R1ESL = 0 OR scre.R2ESL = 1) THEN 'ESL 301' "
            ...
            . "WHEN scre.R3Score IS NULL AND scre.R1Score = 1 AND (scre.R1ESL = 0 OR scre.R2ESL = 1) THEN 'Take the ESL writing assessment' "
            . "ELSE 'Undefined' END AS Placement "
            . "FROM [IVCWCPILOT].[dbo].[WSample] AS wspl LEFT JOIN [IVCWCPILOT].[dbo].[Score] AS scre ON wspl.WSampleID = scre.WSampleID "
            . "LEFT JOIN [IVCWCPILOT].[dbo].[Student] AS stud ON wspl.StudentID = stud.StudentID "
            . "WHERE wspl.StatusID = '".$StatusID."'";
